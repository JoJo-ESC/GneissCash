...
"[project]/src/app/api/cash-flow/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const grouping = (searchParams.get('grouping') || 'month').toLowerCase();
        if (grouping !== 'month') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: transactions, error } = await supabase.from('transactions').select('amount, date').eq('user_id', user.id).gte('date', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(periodStart, 'yyyy-MM-dd')).lte('date', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(periodEnd, 'yyyy-MM-dd')).order('date', {
            ascending: true
        });
        if (error) {
            console.error('Failed to load cash flow history:', error);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Failed to load cash flow history'
            }, {
                status: 500
            });
        }
        ...
        transactions?.forEach((transaction)=>{
            const bucket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(transaction.date), 'yyyy-MM');
            const current = aggregates.get(bucket) || {
                income: 0,
                expenses: 0
            };
        ...
        const monthsInterval = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$eachMonthOfInterval$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eachMonthOfInterval"])({
            start: periodStart,
            end: periodEnd
        });
        const points = monthsInterval.map((month, index)=>{
            const bucket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(month, 'yyyy-MM');
            ...
            return {
                bucket,
                label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(month, 'MMM yyyy'),
                income,
                expenses,
                net,
                rollingNet: null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f484a36d._.js.map