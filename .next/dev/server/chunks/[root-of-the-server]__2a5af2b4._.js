...
async function PUT(request) {
    try {
        ...
        const { display_name, avatar_url, monthly_income, savings_goal, goal_deadline, current_saved } = body;
        // Validate inputs
        ...
        if (existing) {
            ...
            const result = await supabase.from('user_settings').update(updates).eq('user_id', user.id).select().single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a5af2b4._.js.map